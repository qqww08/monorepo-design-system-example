...
- `packages/@qqww08/core`: Core React components
- `packages/@qqww08/utils`: Shared React utilities
- `packages/@qqww08/tsconfig`: Shared `tsconfig.json`s used throughout the Turborepo
...
- Support using module path aliases like `@qqww08-core` for imports
- Write MDX for component documentation pages

For example, here's the included Story for our `Button` component:

```js:apps/docs/stories/button.stories.mdx
import { Button } from '@qqww08-core/src';
